...
import { ArrowLeft, Pencil, Trash2, Save, X, Shield, User as UserIcon } from "lucide-react";
        ...
        <div className="overflow-x-auto -mx-3 sm:mx-0">
          <table className="w-full text-sm min-w-[500px]">
            <thead className="bg-slate-50 text-slate-600 text-xs uppercase">
              <tr>
                <th className="text-left px-3 sm:px-4 py-3 font-medium">Nome</th>
                <th className="text-left px-3 sm:px-4 py-3 font-medium">E-mail</th>
                <th className="text-left px-3 sm:px-4 py-3 font-medium">Tipo</th>
                <th className="text-right px-3 sm:px-4 py-3 font-medium">Ações</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-slate-100">
              {list.map((u) => (
                <tr key={u.id} className="hover:bg-slate-50">
                  <td className="px-3 sm:px-4 py-3 text-slate-700 whitespace-nowrap">{u.nome}</td>
                  <td className="px-3 sm:px-4 py-3 text-slate-500 whitespace-nowrap">{u.email}</td>
